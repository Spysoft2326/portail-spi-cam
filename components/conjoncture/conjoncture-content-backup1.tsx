            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
              ...
              <div className="bg-white rounded-xl shadow-sm p-6">
                ...
                <div className="text-2xl font-bold">
                  {(() => {
                    const ca = safeNumber(stats.totalCA);
                    if (ca >= 1_000_000_000) return (ca / 1_000_000_000).toFixed(1) + " Md FCFA";
                    if (ca >= 1_000_000) return (ca / 1_000_000).toFixed(1) + " M FCFA";
              ...
              <div className="bg-white rounded-xl shadow-sm p-6">
                ...
                <div className="text-2xl font-bold">
                  {(() => {
                    const inv = safeNumber(stats.totalInvestissements);
                    if (inv >= 1_000_000_000) return (inv / 1_000_000_000).toFixed(1) + " Md FCFA";
                    if (inv >= 1_000_000) return (inv / 1_000_000).toFixed(1) + " M FCFA";
                    return inv.toLocaleString() + " FCFA";
                  })()}
                </div>
              </div>
            </div>
