...
export default function AdminDashboard() {
  ...
  const validateProduction = async (id: string, action: "validate" | "reject") => {
    try {
      const res = await fetch(`/api/admin/productions/${id}/${action}`, {
        method: "POST",
      });
      if (res.ok) {
        fetchData();
  ...
  const filteredProductions = productions.filter((p) => {
    return !filterStatus || p.statut === filterStatus;
  });
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-gray-500">Gestion du portail SPI-CAM</p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              <div className="bg-white rounded-xl shadow-sm p-6">
                ...
                <div className="text-sm text-gray-500 mt-1">
                  {stats.totalAgents} agents, {stats.totalAdmins} admins
                </div>
              </div>
                        ...
                        <tr key={p.id} className="border-b hover:bg-gray-50">
                          ...
                          <td className="py-3 px-4">
                            <div className="flex justify-center gap-2">
                              <button
                                onClick={() => validateProduction(p.id, "validate")}
                              ...
                              <button
                                onClick={() => validateProduction(p.id, "reject")}
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-xl shadow-sm p-6">
              ...
              <div className="mt-4">
                <Link
                  href="/conjoncture"
                  className="inline-flex items-center gap-2 px-4 py-2 bg-[#007A3D] text-white rounded-lg hover:bg-[#005a2d] transition"
                >
